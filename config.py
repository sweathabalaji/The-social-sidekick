...
class Config:
    ...
    def validate_social_media_config(cls):
        ...
        # Facebook Page Access Token can be the same as Instagram token
        facebook_token = cls.FACEBOOK_PAGE_ACCESS_TOKEN or cls.INSTAGRAM_ACCESS_TOKEN
        if not facebook_token:
            required_fields['FACEBOOK_PAGE_ACCESS_TOKEN'] = None
    ...
    @classmethod
    def get_effective_facebook_token(cls):
        """Get the effective Facebook token (can be same as Instagram token)"""
        return cls.FACEBOOK_PAGE_ACCESS_TOKEN or cls.INSTAGRAM_ACCESS_TOKEN